...
//
const BotName = 'Andi-bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/andi_studio73'; // Nama Instagramlu cok
const whatsapplu = '0882-1769-0485'; // Nomor whatsapplu cok
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Scan Kode QR mu Bor!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Andi404`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Andi404`)
})
